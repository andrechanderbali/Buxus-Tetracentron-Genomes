...
#### conduct two more rounds of training and gene predictions 
...
### align protein sequences witg MAFFT:
...
perl ~/bin/FASconCAT-G_v1.02.pl -l -l -s #generate supermatrix and corresponding partition files
